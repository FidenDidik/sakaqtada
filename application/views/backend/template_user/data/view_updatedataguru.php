                    ...
                    <h5>Update Data Guru</h5>
                        <hr>
                            <?php 
                                ...
                                echo form_open('backend/user/C_Dataguru/update_dataguru', $attrib); 
                               ?>
                                <br>
                                  <?php foreach ($data as $row) : ?>
                                        <div class="form-group">
                                        <input type="hidden" id="hide" name="id_dataguru" value="<?php echo $row->id_dataguru; ?>">
                                    ...
                                    <a href="<?php echo base_url(); ?>index.php/backend/user/C_Dataguru/index" class="btn waves-effect waves-light btn-warning btn-skew">Batal</a>
                                    <?php echo form_close(); ?>
                                </div>
                            </div>
                        </div>
