                                ...
                                <hr>
                                    <?php if(validation_errors() || isset($error)) : ?>
                                        <div class="alert alert-danger" role="alert" align="center">
                                         ...
                                         <?php endif; ?>
                                           <?=form_open_multipart('backend/user/C_Struktur/edit/'.$image->id_struktur)?>
                                            <br>
                                        ...
                                        <?=anchor('backend/user/C_Struktur/index','Cancel',['class'=>'btn waves-effect waves-light btn-warning btn-skew'])?>
                                    </form>
                                </div>
                            </div>
                        </div>
