...
<head>
	<meta charset="utf-8">
	<title>Update sekilas tentang Dinas Pendidikan</title>
</head>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Update Sekilas tentang Dinas Pendidikan</h5>
                                <hr>
                                    <?php if(validation_errors() || isset($error)) : ?>
                                        <div class="alert alert-danger" role="alert" align="center">
                                         ...
                                         <?php endif; ?>
                                           <?=form_open_multipart('backend/user/C_Sekilas/edit/'.$image->id_sekilas)?>
                                            <br>
                                                ...
                                                <textarea class="form-control" name="uraian" rows="15"><?=$uraian?></textarea>
                                                </div>
                                            <button type="submit" class="btn waves-effect waves-light btn-primary btn-skew">Update</button>
                                        <?=anchor('backend/user/C_Sekilas/index','Cancel',['class'=>'btn waves-effect waves-light btn-warning btn-skew'])?>
                                    </form>
                                </div>
                            </div>
                        </div>
