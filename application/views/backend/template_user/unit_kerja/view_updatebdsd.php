                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Update Bidang Pembinaan SD</h5>
                                <hr>
                                <?php 
                                $attrib = array('role'=>'form');
                                echo form_open('backend/user/C_Bdsd/update_bdsd', $attrib); 
                               ?>
                                <br>
                                    <div class="form-group">
                                    <?php foreach ($data as $row) : ?>
                                        <input type="hidden" id="hide" name="id_bdsd" value="<?php echo $row->id_bdsd; ?>">
                                        <label>Judul</label>
                                    ...
                                    <a href="<?php echo base_url(); ?>index.php/backend/user/C_Bdsd/index" class="btn waves-effect waves-light btn-warning btn-skew">Cancel</a>
                                    <?php echo form_close(); ?>
                                </div>
                            </div>
                        </div>
