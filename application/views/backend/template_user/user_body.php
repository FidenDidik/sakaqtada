                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="<?php echo base_url()."assets_mega" ?>/images/avatar-4.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="<?php echo base_url()."assets_mega" ?>/images/avatar-5.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                            <div class="d-inline-block">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="<?php echo base_url()."assets_mega" ?>/images/avatar-3.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                            <div class="d-inline-block">
                                                                                <h6>William Jem</h6>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <div class="d-inline-block align-middle">
                                                                            <img src="<?php echo base_url()."assets_mega" ?>/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                            <div class="d-inline-block">
                                                                                <h6>David Jones</h6>
                                                                                <p class="text-muted m-b-0">Developer</p>
                                                                            </div>
                                            ...
                                            <div class="col-xl-4 col-md-12">
                                                <div class="card ">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="align-middle m-b-30">
                                                            <img src="<?php echo base_url()."assets_mega" ?>/images/avatar-1.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                            <div class="d-inline-block">
                                                                <h6>David Jones</h6>
                                                                <p class="text-muted m-b-0">Developer</p>
                                                            </div>
            ...
            <ul class="iew-download">
                <li>
                    <a href="http://www.google.com/chrome/">
                        <img src="<?php echo base_url()."assets_mega" ?>/images/browser/chrome.png" alt="Chrome">
                        <div>Chrome</div>
                    </a>
                </li>
                ...
                <li>
                    <a href="http://www.opera.com">
                        <img src="<?php echo base_url()."assets_mega" ?>/images/browser/opera.png" alt="Opera">
                        <div>Opera</div>
                    </a>
                </li>
                <li>
                    <a href="https://www.apple.com/safari/">
                        <img src="<?php echo base_url()."assets_mega" ?>/images/browser/safari.png" alt="Safari">
                        <div>Safari</div>
                    </a>
                </li>
                <li>
                    <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                        <img src="<?php echo base_url()."assets_mega" ?>/images/browser/ie.png" alt="">
                        <div>IE (9 & above)</div>
                    </a>
                </li>
            </ul>
